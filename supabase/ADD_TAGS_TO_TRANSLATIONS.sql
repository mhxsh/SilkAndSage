-- ========================================
-- 标签国际化：在 generated_page_translations 表中添加 tags 字段
-- ========================================
...
-- 4. 在 generated_pages 表的 tags 保留中文版本（用于搜索和统计）
...
BEGIN
    ...
    RAISE NOTICE '- generated_page_translations 表已添加 tags 字段';
    RAISE NOTICE '- 中文翻译已设置中文标签';
    RAISE NOTICE '- 英文翻译已设置英文标签';
    RAISE NOTICE '- generated_pages 表保留中文标签用于统计';
END $$;
